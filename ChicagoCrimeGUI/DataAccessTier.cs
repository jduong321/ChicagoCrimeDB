...
namespace DataAccessTier
{
  ...
  public class Data
  {
    ...
    public Data(string DatabaseFilename)
    {
      ...
      _DBConnectionInfo = String.Format(@"Data Source = (LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Jacky\Downloads\CrimeDB.mdf;Integrated Security = True;",
        version,
        DatabaseFilename);
    }
    ///
    ...
    public object ExecuteScalarQuery(string sql)
    {
            ...
            string filename = "C:\\Users\\Jacky\\Downloads\\CrimeDB.mdf";
